...
<!--          </div>-->
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" name="submit" value="submitted" class="btn btn-primary btn-block">Register</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
	  <div class="row" style="margin-top: 10px;margin-left: 25px;margin-right: 25px;margin-bottom: 10px">
